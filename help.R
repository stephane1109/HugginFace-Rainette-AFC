...
ui_aide_huggingface <- function() {
  tagList(
    ...
    tags$p(tags$b("min_split_members"), " : nombre minimal de documents/segments par classe. Si une partition produit une classe finale en dessous de ce seuil, l'application réduit automatiquement k jusqu'à obtenir des classes conformes (ou affiche une erreur si impossible)."),
